//调试表原始对象
{
        ...
        "value":"create table mails_single\n(\n    id             int          not null\n        primary key,\n    sender         varchar(255) null comment '发件人',\n    sender_mail    varchar(255) null comment '发邮人邮箱',\n    sender_user_id int          null comment '发件人用户 id',\n    receiver_mails varchar(500) null comment '接收人邮箱，多个则使用逗号隔开',\n    receivers_info text         null comment '抄送人信息，名字+邮箱地址',\n    cc_mails       varchar(500) null comment '抄送人邮箱，逗号隔开',\n    cc_info        text         null comment '抄送人信息 名字+邮箱',\n    stats          int          null comment '-1 发送失败， 0 发送中， 1 发送成功',\n    title          varchar(255) null,\n    body           longtext     null,\n    attachment     varchar(255) null comment '附件硬盘地址'\n)\n    charset = utf8mb4;\n\n"
        },{
        "name":"getDeclaration",
        "desc":"public com.intellij.psi.PsiElement com.intellij.database.psi.DbElementImpl.getDeclaration()",
        "value":"mails_single: table"
        },{
        "name":"getChildren",
        ...
        "value":"DB VirtualFile: table, mail.mails_single [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        ...
        "value":"{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@78f81152, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@78fa7c3b, lastComputedIcon=com.intellij.reference.SoftReference@6481f793}"
        },{
...
//调试列原始对象
        ...
        "name":"getText",
        "desc":"public java.lang.String com.intellij.database.psi.DbElementImpl.getText()",
        "value":"alter table mails_single\n    add id int not null;\n\n"
        },{
        "name":"getDeclaration",
        "desc":"public com.intellij.psi.PsiElement com.intellij.database.psi.DbElementImpl.getDeclaration()",
        "value":"id: column"
        ...
        "name":"getVirtualFile",
        "desc":"public com.intellij.openapi.vfs.VirtualFile com.intellij.database.psi.DbElementImpl.getVirtualFile()",
        "value":"DB VirtualFile: column, mail.mails_single.id (DDL) [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.isQuoted()",
        "value":"true"
        ...
        "name":"getLocationString",
        "desc":"public java.lang.String com.intellij.database.psi.DbElementImpl.getLocationString()",
        "value":"mail.mails_single [172.26.59.35]"
        },{
        "name":"processChildren",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.processChildren(com.intellij.psi.search.PsiElementProcessor<? super com.intellij.psi.PsiFileSystemItem>)",
        "value":null
        ...
        "name":"getUserDataString",
        "desc":"public java.lang.String com.intellij.openapi.util.UserDataHolderBase.getUserDataString()",
        "value":"{CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@33efc1aa}"
        },{
        "name":"isUserDataEmpty",
        "desc":"public boolean com.intellij.openapi.util.UserDataHolderBase.isUserDataEmpty()",
        "value":"false"
