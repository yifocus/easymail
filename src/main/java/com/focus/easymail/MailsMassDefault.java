//调试表原始对象
{
        ...
        "value":"create table mails_mass\n(\n    id           int          not null\n        primary key,\n    sender_mail  varchar(255) null,\n    send_user_id int          null comment '发送人用户id',\n    send_info    varchar(255) null comment '发送人信息',\n    title        varchar(255) null comment '发送标题',\n    body         varchar(255) null comment '发送正文',\n    status       varchar(255) null comment '状态：-1 部分发送失败， 0 发送中， 1 发送完成全部成功， ',\n    attachment   varchar(255) null comment '附件地址',\n    create_date  datetime     null\n)\n    charset = utf8mb4;\n\n"
        },{
        "name":"getDeclaration",
        "desc":"public com.intellij.psi.PsiElement com.intellij.database.psi.DbElementImpl.getDeclaration()",
        "value":"mails_mass: table"
        },{
        "name":"getChildren",
        ...
        "value":"DB VirtualFile: table, mail.mails_mass [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        ...
        "value":"{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@35faf740, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@9cd67b3}"
        },{
...
//调试列原始对象
        ...
        "name":"getVirtualFile",
        "desc":"public com.intellij.openapi.vfs.VirtualFile com.intellij.database.psi.DbElementImpl.getVirtualFile()",
        "value":"DB VirtualFile: column, mail.mails_mass.id (DDL) [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.isQuoted()",
        "value":"true"
        ...
        "name":"getLocationString",
        "desc":"public java.lang.String com.intellij.database.psi.DbElementImpl.getLocationString()",
        "value":"mail.mails_mass [172.26.59.35]"
        },{
        "name":"processChildren",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.processChildren(com.intellij.psi.search.PsiElementProcessor<? super com.intellij.psi.PsiFileSystemItem>)",
        "value":null
        ...
        "name":"getUserDataString",
        "desc":"public java.lang.String com.intellij.openapi.util.UserDataHolderBase.getUserDataString()",
        "value":"{CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@590ed162}"
        },{
        "name":"isUserDataEmpty",
        "desc":"public boolean com.intellij.openapi.util.UserDataHolderBase.isUserDataEmpty()",
        "value":"false"
