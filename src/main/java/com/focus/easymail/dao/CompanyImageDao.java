...
public interface CompanyImageDao {
     ...
     *
     * @param entities List<CompanyImage> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<CompanyImage> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<CompanyImage> entities);
