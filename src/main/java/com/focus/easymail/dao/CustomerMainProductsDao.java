...
public interface CustomerMainProductsDao {
     ...
     *
     * @param entities List<CustomerMainProducts> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<CustomerMainProducts> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<CustomerMainProducts> entities);
