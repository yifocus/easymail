//调试表原始对象
{
        ...
        "value":"create table company\n(\n    id                int          not null\n        primary key,\n    simple_name       varchar(255) null comment '客户公司简称',\n    name              varchar(255) null comment '公司全称',\n    code              varchar(255) null comment '客户代码，自动生成',\n    identify          varchar(64)  null comment '唯一标识',\n    country_id        int(255)     null comment '国家',\n    city              varchar(255) null comment '城市',\n    province          varchar(255) null comment '省份、港口',\n    address           varchar(255) null comment '客户公司地址',\n    user_id           int          null comment '关联的用户Id',\n    category_id       int          null comment '客户类型',\n    phone             varchar(255) null comment '电话',\n    fax               varchar(255) null comment '传真',\n    website           varchar(255) null comment '网站',\n    source_id         int          null comment '来源',\n    product_id        int          null comment '主营产品',\n    bussiness_type_id int          null comment '业务类型',\n    remark            text         null comment '备注',\n    level             int(255)     null comment '等级， 1 非常重要， 2 重要 ， 3 一般',\n    bank_info         text         null comment '银行信息',\n    create_date       datetime     null comment '建档时间',\n    country_date      datetime     null comment '客户当地时间',\n    update_date       datetime     null comment '更新时间'\n)\n    charset = utf8mb4;\n\n"
        },{
        "name":"getDeclaration",
        ...
        "value":"DB VirtualFile: table, mail.company [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        ...
        "value":"{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@565173ab, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@2d5237fc}"
        },{
...
//调试列原始对象
        ...
        "name":"getVirtualFile",
        "desc":"public com.intellij.openapi.vfs.VirtualFile com.intellij.database.psi.DbElementImpl.getVirtualFile()",
        "value":"DB VirtualFile: column, mail.company.id (DDL) [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.isQuoted()",
        "value":"true"
        ...
        "name":"getLocationString",
        "desc":"public java.lang.String com.intellij.database.psi.DbElementImpl.getLocationString()",
        "value":"mail.company [172.26.59.35]"
        },{
        "name":"processChildren",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.processChildren(com.intellij.psi.search.PsiElementProcessor<? super com.intellij.psi.PsiFileSystemItem>)",
        "value":null
        ...
        "name":"getUserDataString",
        "desc":"public java.lang.String com.intellij.openapi.util.UserDataHolderBase.getUserDataString()",
        "value":"{CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@3ef52c35}"
        },{
        "name":"isUserDataEmpty",
        "desc":"public boolean com.intellij.openapi.util.UserDataHolderBase.isUserDataEmpty()",
        "value":"false"
