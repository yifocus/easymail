//调试表原始对象
{
        ...
        "value":"create table customer_country\n(\n    id                int          not null\n        primary key,\n    country_code      varchar(255) null comment '国家代码',\n    name              varchar(255) null comment '国家名称',\n    english_name      varchar(255) null comment '英文名称',\n    custom_code       varchar(255) null comment '海关代码',\n    area              varchar(255) null comment '所属地区',\n    country_time_zone varchar(255) null comment '时区'\n)\n    charset = utf8mb4;\n\n"
        },{
        "name":"getDeclaration",
        "desc":"public com.intellij.psi.PsiElement com.intellij.database.psi.DbElementImpl.getDeclaration()",
        "value":"customer_country: table"
        },{
        "name":"getChildren",
        ...
        "value":"DB VirtualFile: table, mail.customer_country [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        ...
        "value":"{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@32840877, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@39e556a9}"
        },{
...
//调试列原始对象
        ...
        "name":"getText",
        "desc":"public java.lang.String com.intellij.database.psi.DbElementImpl.getText()",
        "value":"alter table customer_country\n    add id int not null;\n\n"
        },{
        "name":"getDeclaration",
        "desc":"public com.intellij.psi.PsiElement com.intellij.database.psi.DbElementImpl.getDeclaration()",
        "value":"id: column"
        ...
        "name":"getVirtualFile",
        "desc":"public com.intellij.openapi.vfs.VirtualFile com.intellij.database.psi.DbElementImpl.getVirtualFile()",
        "value":"DB VirtualFile: column, mail.customer_country.id (DDL) [172.26.59.35] (Valid)"
        },{
        "name":"isQuoted",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.isQuoted()",
        "value":"true"
        ...
        "name":"getLocationString",
        "desc":"public java.lang.String com.intellij.database.psi.DbElementImpl.getLocationString()",
        "value":"mail.customer_country [172.26.59.35]"
        },{
        "name":"processChildren",
        "desc":"public boolean com.intellij.database.psi.DbElementImpl.processChildren(com.intellij.psi.search.PsiElementProcessor<? super com.intellij.psi.PsiFileSystemItem>)",
        "value":null
        ...
        "name":"getUserDataString",
        "desc":"public java.lang.String com.intellij.openapi.util.UserDataHolderBase.getUserDataString()",
        "value":"{CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@66a069d2}"
        },{
        "name":"isUserDataEmpty",
        "desc":"public boolean com.intellij.openapi.util.UserDataHolderBase.isUserDataEmpty()",
        "value":"false"
